/**
 *  Wifi Presence Service Manager
 *
 *  Copyright 2020 Ben Millis
 *
 ...
 */
definition(
		name: "Wifi Presence Service Manager",
		namespace: "laserquestwascool",
		author: "Ben Millis",
		description: "This is the service manager to handle wifi router discovery",
...
preferences {
	page(name: "searchTargetSelection", title: "UPnP Search Target", nextPage: "deviceDiscovery") {
		section("Search Target") {
			input "searchTarget", "text", title: "Search Target", defaultValue: "urn:schemas-upnp-org:device:InternetGatewayDevice:1", required: true
		}
	}
